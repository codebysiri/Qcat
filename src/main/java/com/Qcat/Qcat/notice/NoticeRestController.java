...
public class NoticeRestController {
    ...
    public List<Map<String, Object>> searchNotices(@RequestParam Map<String, String> searchValue) {
        return noticeService.searchNotices(searchValue);
    }

    @PostMapping("/notice/delete/{notice_id}")
    public int deleteNotice(@PathVariable("notice_id") int notice_id) {
        return noticeService.deleteNotice(notice_id);
    }

    // REPLY CRUD
    @PostMapping("/notice/reply/{reply_id}")
    public List<Map<String, Object>> getReply(@PathVariable("reply_id") int reply_id) {
        return noticeService.getReply(reply_id);
    }

    @PostMapping("/notice/insertReply")
